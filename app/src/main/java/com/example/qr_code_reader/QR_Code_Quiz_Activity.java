...
import com.example.qr_code_reader.QR_Code_Correct_Activity;
import com.example.qr_code_reader.QR_Code_False_Activity;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        pass_btn.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent( getApplicationContext(), com.example.customlistview.QR_Code_Default_Sub_Activity.class );
